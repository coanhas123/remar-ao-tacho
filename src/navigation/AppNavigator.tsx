...
import { ExploreScreen, HistoryDetailScreen, HomeScreen, MapScreen, MoodboardDetailScreen, ProductModalScreen, ProfileScreen } from '@/src/screens';
...
export const AppNavigator = () => {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false, contentStyle: { backgroundColor: theme.colors.background } }}>
      ...
      />
      <Stack.Screen name="MoodboardDetail" component={MoodboardDetailScreen} options={{ headerShown: false }} />
    </Stack.Navigator>
  );
};
